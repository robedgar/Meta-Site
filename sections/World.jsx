  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-35 left-[60%] w-[180px] h-[136px] p-[6px] rounded-sm">
          <img
            src="image-right.png" alt="people" className="w-full h-full"
          />
        </div>
        <div className="absolute top-1/3 right-[60%] w-[180px] h-[136px] p-[6px] rounded-sm">
          <img
            src="image-left.png" alt="people" className="w-full h-full"
          />
        </div>
      </motion.div>
    </motion.div>
